...
void c2_char_punch() 
{
  ...
  if(!p1)
  {
    ...
    if (puncde == 1) 
    {
      strcpy(trace_1, "c2z_char.c punch #1");
      trace_rec_3();
    }
    ...
    if (puncde == 1) 
    {
      strcpy(trace_1, "c2z_char.c punch #2");
      trace_rec_3();
    }
    work_use_ct[52]++;
    ...
    if (puncde == 1) 
    {
      strcpy(trace_1, "c2z_char.c punch #3");
      trace_rec_3();
    }
    ...
    if(x99 != 1)
    {
      ...
      if (puncde == 1) 
      {
        strcpy(trace_1, "c2z_char.c punch #4");
        trace_rec_3();
      }
    }
    ...
    if (puncde == 1) 
    {
      strcpy(trace_1, "c2z_char.c punch #5");
      trace_rec_3();
    }
    work_use_ct[74]++;
    ...
    if (puncde == 1) 
    {
      strcpy(trace_1, "c2z_char.c punch #6");
      trace_rec_3();
    }
  }
  ...
  if(p1)
  {
    ...
    if (puncde == 1) 
    {
      strcpy(trace_1, "c2z_char.c punch #7");
      trace_rec_3();
    }
    ...
    if (puncde == 1) 
    {
      strcpy(trace_1, "c2z_char.c punch #8");
      trace_rec_3();
    }
    ...
    if (puncde == 1) 
    {
      strcpy(trace_1, "c2z_char.c punch #9");
      trace_rec_3();
    }
    convert = 1;
  }
  ...
  if(comma == 1)
  {
    ...
    if (puncde == 1) 
    {
      strcpy(trace_1, "c2z_char.c punch #10");
      trace_rec_3();
    }
    ...
    if (puncde == 1) 
    {
      strcpy(trace_1, "c2z_char.c punch #11");
      trace_rec_3();
    }
    work_use_ct[52]++;
    ...
    if (puncde == 1) 
    {
      strcpy(trace_1, "c2z_char.c punch #12");
      trace_rec_3();
    }
    ...
    if(x99 != 1)
    {
      ...
      if (puncde == 1) 
      {
        strcpy(trace_1, "c2z_char.c punch #13");
        trace_rec_3();
      }
    }
    ...
    if (puncde == 1) 
    {
      strcpy(trace_1, "c2z_char.c punch #14");
      trace_rec_3();
    }
    work_use_ct[74]++;
    ...
    if (puncde == 1) 
    {
      strcpy(trace_1, "c2z_char.c punch #15");
      trace_rec_3();
    }
  }
}
