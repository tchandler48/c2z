...
void c2_char() 
{
  ...
  if (traceflg == 1) 
  {
    strcpy(trace_1, "c2z_char.c c2_char START");
    trace_rec_1();
  }
  ...
  * ********************************** */
  if (op_code == 2) 
  {
    if (traceflg == 1) 
    {
      strcpy(trace_1, "c2z_char.c c2_char CHAR");
      trace_rec_1();
    }
...
void c2_char_punch() 
{
 ...
 /* pgm_label(); */
  ...
  if(!p1)
  {
    ...
    if (puncde == 1) 
    {
      strcpy(trace_1, "c2z_char.c c2_char_punch #2");
      trace_rec_3();
    }
    work_use_ct[52]++;
    ...
    if (puncde == 1) 
    {
      strcpy(trace_1, "c2z_char.c c2_char_punch #3");
      trace_rec_3();
    }
    ...
    if(x99 != 1)
    {
      ...
      if (puncde == 1) 
      {
        strcpy(trace_1, "c2z_char.c c2_char_punch #4");
        trace_rec_3();
      }
    }
    ...
    if (puncde == 1) 
    {
      strcpy(trace_1, "c2z_char.c c2_char_punch #5");
      trace_rec_3();
    }
    work_use_ct[74]++;
  ...
  if(p1)
  {
    ...
    if (puncde == 1) 
    {
      strcpy(trace_1, "c2z_char.c c2_char_punch #8");
      trace_rec_3();
    }
    ...
    if (puncde == 1) 
    {
      strcpy(trace_1, "c2z_char.c c2_char_punch #9");
      trace_rec_3();
    }
    convert = 1;
  }
  ...
  if(comma == 1)
  {
    ...
    if (puncde == 1) 
    {
      strcpy(trace_1, "c2z_char.c c2_char_punch #10");
      trace_rec_3();
    }
    ...
    if (puncde == 1) 
    {
      strcpy(trace_1, "c2z_char.c c2_char_punch #12");
      trace_rec_3();
    }
    work_use_ct[52]++;
    ...
    if (puncde == 1) 
    {
      strcpy(trace_1, "c2z_char.c c2_char_punch #13");
      trace_rec_3();
    }
    ...
    if(x99 != 1)
    {
      ...
      if (puncde == 1) 
      {
        strcpy(trace_1, "c2z_char.c c2_char_punch #14");
        trace_rec_3();
      }
    }
    ...
    if (puncde == 1) 
    {
      strcpy(trace_1, "c2z_char.c c2_char_punch #15");
      trace_rec_3();
    }
    work_use_ct[74]++;
    ...
    if (puncde == 1) 
    {
      strcpy(trace_1, "c2z_char.c c2_char_punch #16");
      trace_rec_3();
    }
  }
}
