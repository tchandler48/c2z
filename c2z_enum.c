...
printf("c2_enum_scan tfield3 = %s\n",tfield3);
		...
		if(xf == 1)
			{
				printf("c2z_enum.c c2z_enum_scan E-10 tfield1 Already Defined = %s\n",tfield1);
				c2_error();	
			}
		...
		if(s == 7)
			{
				if(x99 == 0)
					...
					{
						printf("c2z_enum.c c2_enum_scan E-11 Negative Conversion Error\n");
						c2_error();
					}
			}
		...
		if(s > 7)
			{
				printf("c2z_enum.c c2_enum_scan E-12 Length ERROR\n");
				c2_error();
			}
		...
		if(xf == 1)
			{
				printf("c2z_enum.c c2z_enum_scan E-13 tfield4 Already Defined = %s\n",tfield4);
				c2_error();	
			}
		...
		if(s == 7)
			{
				if(x99 == 0)
					...
					{
						printf("c2z_enum.c c2_enum_scan E-14 Negative Conversion Error\n");
						c2_error();
					}
			}
		...
		if(s > 7)
			{
				printf("c2z_enum.c c2_enum_scan E-15 Length ERROR\n");
				c2_error();
			}
		...
		if(xf == 1)
			{
				printf("c2z_enum.c c2z_enum_scan E-16 tfield4 Already Defined = %s\n",tfield5);
				c2_error();	
			}
		...
		if(s == 7)
			{
				if(x99 == 0)
					...
					{
						printf("c2z_enum.c c2_enum_scan E-17 Negative Conversion Error\n");
						c2_error();
					}
			}
		...
		if(s > 7)
			{
				printf("c2z_enum.c c2_enum_scan E-18 Length ERROR\n");
				c2_error();
			}
		...
		if(xf == 1)
			{
				printf("c2z_enum.c c2z_enum_scan E-19 tfield6 Already Defined = %s\n",tfield6);
				c2_error();	
			}
		...
		if(s == 7)
			{
				if(x99 == 0)
					...
					{
						printf("c2z_enum.c c2_enum_scan E-20 Negative Conversion Error\n");
						c2_error();
					}
			}
		...
		if(s > 7)
			{
				printf("c2z_enum.c c2_enum_scan E-21 Length ERROR\n");
				c2_error();
			}
		...
		if(xf == 1)
			{
				printf("c2z_enum.c c2z_enum_scan E-22 tfield7 Already Defined = %s\n",tfield7);
				c2_error();	
			}
		...
		if(s == 7)
			{
				if(x99 == 0)
					...
					{
						printf("c2z_enum.c c2_enum_scan E-23 Negative Conversion Error\n");
						c2_error();
					}
			}
		...
		if(s > 7)
			{
				printf("c2z_enum.c c2_enum_scan E-24 Length ERROR\n");
				c2_error();
			}
		...
		if(xf == 1)
			{
				printf("c2z_enum.c c2z_enum_scan E-25 tfield8 Already Defined = %s\n",tfield8);
				c2_error();	
			}
		...
		if(s == 7)
			{
				if(x99 == 0)
					...
					{
						printf("c2z_enum.c c2_enum_scan E-26 Negative Conversion Error\n");
						c2_error();
					}
			}
		...
		if(s > 7)
			{
				printf("c2z_enum.c c2_enum_scan E-27 Length ERROR\n");
				c2_error();
			}
		...
		if(xf == 1)
			{
				printf("c2z_enum.c c2z_enum_scan E-28 tfield9 Already Defined = %s\n",tfield9);
				c2_error();	
			}
		...
		if(s == 7)
			{
				if(x99 == 0)
					...
					{
						printf("c2z_enum.c c2_enum_scan E-29 Negative Conversion Error\n");
						c2_error();
					}
			}
		...
		if(s > 7)
			{
				printf("c2z_enum.c c2_enum_scan E-30 Length ERROR\n");
				c2_error();
			}
		...
		if(xf == 1)
			{
				printf("c2z_enum.c c2z_enum_scan E-31 tfield10 Already Defined = %s\n",tfield10);
				c2_error();	
			}
		...
		if(s == 7)
			{
				if(x99 == 0)
					...
					{
						printf("c2z_enum.c c2_enum_scan E-32 Negative Conversion Error\n");
						c2_error();
					}
			}
		...
		if(s > 7)
			{
				printf("c2z_enum.c c2_enum_scan E-33 Length ERROR\n");
				c2_error();
			}
		...
		if(xf == 1)
			{
				printf("c2z_enum.c c2z_enum_scan E-34 tfield11 Already Defined = %s\n",tfield11);
				c2_error();	
			}
		...
		if(s == 7)
			{
				if(x99 == 0)
					...
					{
						printf("c2z_enum.c c2_enum_scan E-35 Negative Conversion Error\n");
						c2_error();
					}
			}
		...
		if(s > 7)
			{
				printf("c2z_enum.c c2_enum_scan E-36 Length ERROR\n");
				c2_error();
			}
		...
		if(xf == 1)
			{
				printf("c2z_enum.c c2z_enum_scan E-37 tfield12 Already Defined = %s\n",tfield12);	
				c2_error();
			}
		...
		if(s == 7)
			{
				if(x99 == 0)
					...
					{
						printf("c2z_enum.c c2_enum_scan E-38 Negative Conversion Error\n");
						c2_error();
					}
			}
		...
		if(s > 7)
			{
				printf("c2z_enum.c c2_enum_scan E-39 Length ERROR\n");
				c2_error();
			}
