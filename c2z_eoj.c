...
void c2_eoj()
	{
		...
		if(trace_flag == 1)
			{
				strcpy(trace_1, "c2z_eoj.c wtoalpha start");
			}
		...
		if(punch_code == 1)
			{
				strcpy(trace_1, "c2z_eoj.c wtoalpha #3");
				trace_rec_3();
			}
		...
		* *************************************************** */	
		...
		strcpy(wk_remark, " zero dec printf */");
		write_remark();
		if(punch_code == 1)
			{
				strcpy(trace_1, "c2z_eoj.c wtoimvc #36");
		...
		strcpy(a_string, "         MVC   0(12,R9),0(R8)");
		src_line();
		if(punch_code == 1)
			{
				strcpy(trace_1, "c2z_eoj.c wtoimvc #52");
		...
		strcpy(a_string, "         ED    0(12,R9),0(R8)"); 
		src_line();
		if(punch_code == 1)
			{
				strcpy(trace_1, "c2z_eoj.c wtoimvc #55");
		...
		strcpy(a_string, "         MVC   0(10,R9),2(R8)");
		src_line();
		if(punch_code == 1)
			{
				strcpy(trace_1, "c2z_eoj.c wtoimvc #58");
	...
	if(punch_code == 1)
		{
			strcpy(trace_1, "c2z_eoj.c EQUREGS #1");
			trace_rec_3();
		}
	
	strcpy(a_string, "         EQUREGS");
	src_line();
	if(punch_code == 1)
		{
	...
	strcpy(a_string, "C370PRTR EQU   R11");
	strcpy(wk_remark, "c2 gen variable  */");
	write_short();
	if(punch_code == 1)
		{
			strcpy(trace_1, "c2z_eoj.c Variables #1");
			trace_rec_3();
		}
	...
	if(punch_code == 1)
		{
			strcpy(trace_1, "c2z_eoj.c Variables #2");
			trace_rec_3();
		}
	...
	if(punch_code == 1)
		{
			strcpy(trace_1, "c2z_eoj.c Variables #3");
			trace_rec_3();
		}
	...
	if(punch_code == 1)
		{
			strcpy(trace_1, "c2z_eoj.c Math Literal #1");
			trace_rec_3();
		}
	...
	if(punch_code == 1)
		{
			strcpy(trace_1, "c2z_eoj.c Math Literal #2");
			trace_rec_3();
		}

	strcpy(a_string, "* Math Literals ");
	src_line();
	if(punch_code == 1)
		{
			strcpy(trace_1, "c2z_eoj.c Math Literal #3");
			trace_rec_3();
		}
	...
	if(punch_code == 1)
		{
			strcpy(trace_1, "c2z_eoj.c Math Literal #4");
			trace_rec_3();
		}

	for(I=0; I < lit_ct; I++)
		{
			if(w_literal[I].lit_type == 1)
				{
					if(w_literal[I].lit_rct == w_literal[I].lit_use_rct)
						{
							strcpy(a_string, w_literal[I].lit_cname);
							check_length();
							strcat(a_string, "DC    PL6'");
							strcat(a_string, w_literal[I].lit_value);
							strcat(a_string, "'");
							strcpy(wk_remark, "  ");
							snprintf(wk_strg, sizeof(wk_strg), "%d", w_literal[I].lit_rct);
							strcat(wk_remark, wk_strg);
							strcat(wk_remark, " */");
							write_remark();
							if(punch_code == 1)
								{
									strcpy(trace_1, "c2z_eoj.c Math Literal #5");
									trace_rec_3();
								}
						}
				}
	...
	for(I=0; I < lit_ct; I++)
		{
			if(w_literal[I].lit_type == 2)
				{
					if(w_literal[I].lit_rct == w_literal[I].lit_use_rct)
						{
							strcpy(a_string, w_literal[I].lit_cname);
							check_length();
							strcat(a_string, "DC    D'");
							strcat(a_string, w_literal[I].lit_value);
							strcat(a_string, "'");
							strcpy(wk_remark, "  ");
							snprintf(wk_strg, sizeof(wk_strg), "%d", w_literal[I].lit_rct);
							...
							if(punch_code == 1)
								{
									strcpy(trace_1, "c2z_eoj.c Math Literal #6");
									trace_rec_3();
								}
						}
				}
	...
	for(I=0; I < gv_ct; I++)
		{	
			...
			if((ret == 0) && (convert == 0))
				{
					/*  punch out table entry for array */
					...
					strcat(a_string, ")");
                                   strcpy(wk_remark, " ");
                                   strcat(wk_remark, gw_variable[I].gv_name);
                                   strcat(wk_remark, " */");
                                   write_remark();
					if(punch_code == 1)
						{
			...
			if((ret == 0) && (convert == 0))
				{
					...
					if(x3 == 0)
						{
							printf("c2z_eoj.c c2_eoj E-173 tfield9 Not Found = %s\n",tfield9);
							c2_error();
						}
					...
					strcat(a_string, wk_strg);
					strcat(a_string, "CL(");
					strcpy(tfield2, w_struc[I].st_cname);
					strcat(tfield2, "L");
					strcat(a_string, tfield2);
					strcat(a_string, ")");
                                   strcpy(wk_remark, " ");
                                   strcat(wk_remark, w_struc[I].st_name);
                                   strcat(wk_remark, " */");
                                   write_remark();
					if(punch_code == 1)
						{
			...
			if(ret == 0) 
				{
					...
					ret1 = strcmp(" ", gw_variable[I].gv_value);
					if(ret1 != 0)
						{
							strcat(a_string, "' '");	
						}
...
*												strcat(a_string, "' '");
						...
						strcpy(a_string, "* c2z Parser Variables ");
						src_line();
						if(punch_code == 1)
							{
						...
						if(work_use_ct[12] > 0)
							{
								strcpy(a_string, "C370M89  DC    PL6'0'");
								strcpy(wk_remark, "c2z gen variable  */");
								write_short();
								if(punch_code == 1)
									{
						...
						if(work_use_ct[13] > 0)
							{
								strcpy(a_string, "C370M98  DC    PL6'0'");
								strcpy(wk_remark, "c2z gen variable  */");
								write_short();
								if(punch_code == 1)
									{
						...
						strcpy(a_string, "C370N4   DC    PL6'9999'");
						strcpy(wk_remark, "c2z num(2)  */");
						write_short();
						if(punch_code == 1)
							{
						...
						strcpy(a_string, "C370N6   DC    PL6'999999'");
						strcpy(wk_remark, "c2z num(6)  */");
						write_short();
						if(punch_code == 1)
							{
						...
						if(work_use_ct[49] > 0)
							{
								...
								if(punch_code == 1)
									{
										strcpy(trace_1,"c2z Parser Var #66");									
										trace_rec_3();
									}
							}
						...
						if(work_use_ct[50] > 0)
							{
								...
								if(punch_code == 1)
									{
										strcpy(trace_1,"c2z Parser Var #67");									
										trace_rec_3();
									}
							}
						...
						if(work_use_ct[78] > 0)
							{
								...
								if(punch_code == 1)
									{
										strcpy(trace_1,"c2z Parser Var #68");									
										trace_rec_3();
									}
							}
						...
						if(work_use_ct[31] > 0)
							{
								strcpy(a_string, "C370ISDG DC    PL6'0'");
								strcpy(wk_remark, "c2z gen variable  */");
								write_short();
								if(punch_code == 1)
									{
						...
						if(var_use[11] > 0)
							{
								strcpy(a_string, "C370ISRG DC    F'0'");
								strcpy(wk_remark, "c2z gen variable  */");
								write_short();
								if(punch_code == 1)
									{
						...
						if(work_use_ct[77] > 0)
							{
								strcpy(a_string, "C370ECB  DS    F'0'");
								strcpy(wk_remark, "c2z gen variable  */");
								write_short();
								if(punch_code == 1)
									trace_rec_3();
						...
						if(work_use_ct[35] > 0)
							{
								...
								strcpy(a_string, "C370UCA  DC    C'A'");
								strcpy(wk_remark, "c2z gen variable  */");
								write_short();
								if(punch_code == 1)
									{
						...
						if(work_use_ct[36] > 0)
							{
								...
								strcpy(a_string, "C370UCZ  DC    C'Z'");
								strcpy(wk_remark, "c2z gen variable  */");
								write_short();
								if(punch_code == 1)
									{
						...
						if(work_use_ct[37] > 0)
							{
								...
								strcpy(a_string, "C370LCA  DC    C'a'");
								strcpy(wk_remark, "c2z gen variable  */");
								write_short();
								if(punch_code == 1)
									{
						...
						if(work_use_ct[38] > 0)
							{
								...
								strcpy(a_string, "C370LCZ  DC    C'z'");
								strcpy(wk_remark, "c2z gen variable  */");
								write_short();
								if(punch_code == 1)
									{
						...
						if(work_use_ct[25] > 0)
							{
								...
								if(punch_code == 1)
									{
										strcpy(trace_1,"c2z Parser Var #69");									
										trace_rec_3();
									}
							}
						...
						if(punch_code == 1)
							{
								strcpy(trace_1,"c2z Parser Var #70");									
								trace_rec_3();
							}
						...
						if(punch_code == 1)
							{
								strcpy(trace_1,"c2z Parser Var #71");									
								trace_rec_3();
							}
						...
						if(work_use_ct[55] > 0)
							{
								...
								if(punch_code == 1)
									{
										strcpy(trace_1,"c2z Parser Var #72");									
										trace_rec_3();
									}
							}
						...
						if(work_use_ct[26] > 0)
							{
								...
								if(punch_code == 1)
									{
										strcpy(trace_1,"c2z Parser Var #73");									
										trace_rec_3();
									}
							}
						...
						if(work_use_ct[27] > 0)
							{
								strcpy(a_string, "C370EDW4 DC    X'402020202020202020202120'");
								strcpy(wk_remark, "c2z gen variable  */");
								write_short();
								if(punch_code == 1)
									{
						...
						if(punch_code == 1)
							{
								strcpy(trace_1,"c2z Parser Var #80");									
								trace_rec_3();
							}
						...
						if(punch_code == 1)
							{
								strcpy(trace_1,"c2z Parser Var #81");									
								trace_rec_3();
							}
						...
						if(punch_code == 1)
							{
								strcpy(trace_1,"c2z Parser Var #82");									
								trace_rec_3();
							}
						...
						if(punch_code == 1)
							{
								strcpy(trace_1,"c2z Parser Var #83");									
								trace_rec_3();
							}
								...
								if((ret == 0) && (convert == 0))
									{
										...
										x++;
										strcpy(a_string, w_struc[I].st_cname);
										strcpy(tfield2, w_struc[I].st_cname);
										check_length();
										strcat(a_string, "DSECT");
										strcpy(wk_remark, " ");
