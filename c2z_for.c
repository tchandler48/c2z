...
printf("\nc2z_for.c MAIN rct = %d p_string = %s",rct,p_string);
...
printf("c2z_for.c tfield5 = %s fd5_type = %d tfield5a = %s tfield7 = %s pi3 = %d\n",tfield5,fd5_type,tfield5a,tfield7,pi3);
