...
void c2_scan_fputs()
	{
		...
		if(x == 0)
			{
				printf("c2z_fputs.c c2_scan_fputs E-70 field1 Not Found = %s\n",field1);
				c2_error();
			}
		...
		if(x2 == 0)
			{
				printf("c2z_fputs.c c2_scan_fputs E-71 FIELD2 Not Found in File Table = %s\n",field2);
				c2_error();
			}
	}
...
void c2_fputs()
	{
		...
		if(x == 0)
			{
				printf("c2z_fputs.c c2_fputs E-72 field1 Not Found = %s\n",field1);
				c2_error();
			}
