...
void c2_isalnum()
	{
		...
		if(punch_code == 1)
			{
				strcpy(trace_1, "c2z_isalnum.c c2_isalnum #3");
				trace_rec_3();
			}
		var_use[11]++;
		...
		if(punch_code == 1)
			{
				strcpy(trace_1, "c2z_isalnum.c c2_isalnum #4");
				trace_rec_3();
			}
		...
		if(punch_code == 1)
			{
				strcpy(trace_1, "c2z_isalnum.c c2_isalnum #69");
				trace_rec_3();
			}
		...
		if(punch_code == 1)
			{
				strcpy(trace_1, "c2z_isalnum.c c2_isalnum #70");
				trace_rec_3();
			}
