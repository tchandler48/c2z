...
void c2_scan_realloc() 
{
  if (traceflg == 1) 
  {
    strcpy(trace_1, "c2z_realloc.c c2_scan_realloc");
    trace_rec_1();
  }
  ...
  if ((p5) && (p6)) 
  {
    ...
    if (x3 == 0) 
    {
      printf("\nc2z_realloc.c c2_scan_realloc realloc-001 tfield1 Not Found = %s\n", tfield1);
      printf("c2z_realloc.c c2_scan_realloc rct = %d,p_string = %s", rct,p_string);
      erct++;
      convert = 1;
      return;
    }
    ...
    if (x3 == 0) 
    {
      printf("\nc2z_realloc.c c2_scan_realloc realloc-002 tfield2 Not Found = %s\n", tfield2);
      printf("c2z_realloc.c c2_scan_realloc rct = %d,p_string = %s", rct,p_string);
      erct++;
      convert = 1;
      return;
