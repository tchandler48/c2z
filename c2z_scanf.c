...
void c2_scanf()
	{	
		...
		if(x == 0)
			{
				printf("c2z_scanf.c c2_scanf ERROR Invalid edit code\n");
		...
		if(x1 == 1)			
			{
				...
				if(x5 == 0)
					{
						printf("c2z_scanf.c c2_scanf tfield1 Not Found = %s\n",tfield1);
						printf("c2z_scanf.c c2_scanf rct = %d p_string = %s",rct,p_string);
						c2_debug();
						exit(1);
					}
				...
				if(punch_code == 1)
					{
						strcpy(trace_1, "c2z_scanf.c c2_scanf #1");
						trace_rec_3();
					}
				...
				if(punch_code == 1)
					{
						strcpy(trace_1, "c2z_scanf.c c2_scanf #2");
						trace_rec_3();
					}
				work_use_ct[77]++;
				...
				if(punch_code == 1)
					{
						strcpy(trace_1, "c2z_scanf.c c2_scanf #3");
						trace_rec_3();
					}
				...
				if(punch_code == 1)
					{
						strcpy(trace_1, "c2z_scanf.c c2_scanf #4");
						trace_rec_3();
					}
		...
		if(x1 == 2)			
			{
				...
				if(punch_code == 1)
					{
						strcpy(trace_1, "c2z_scanf.c c2_scanf #5");
						trace_rec_3();
					}
				...
				if(punch_code == 1)
					{
						strcpy(trace_1, "c2z_scanf.c c2_scanf #6");
						trace_rec_3();
					}
				work_use_ct[77]++;
				...
				if(punch_code == 1)
					{
						strcpy(trace_1, "c2z_scanf.c c2_scanf #7");
						trace_rec_3();
					}
				...
				if(punch_code == 1)
					{
						strcpy(trace_1, "c2z_scanf.c c2_scanf #8");
						trace_rec_3();
					}
