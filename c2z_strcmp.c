...
void c2_strcmp_1()				/*  x = strcmp(field1,field2)		*/

	{
		...
		if(strg_srch == NULL)
			{
				printf("c2z_strcmp.c c2_strcmp_1 Missing semi-colon at End of Line\n");
				...
				if((ret == 0) && (ret1 == 0))
					{
						...
						if(x1 != 0)
							{
								printf("c2z_strcmp.c c2_strcmp_1 tfield1 Not Numeric = %s\n",tfield1);
								printf("c2z_strcmp.c c2_strcmp_1 rct = %d p_string = %s",rct,p_string);
								c2_debug();
								exit(1);
							}
		...
		if(x == 0)
			{
				printf("c2z_strcmp.c c2_strcmp_1 tfield1 Not Found = %s\n",tfield1);
				printf("c2z_strcmp.c c2_strcmp_1 rct = %d p_string = %s",rct,p_string);
				c2_debug();
				exit(1);
			}
				...
				if((ret == 0) && (ret1 == 0))
					{
						...
						if(x1 != 0)
							{
								printf("c2z_strcmp.c c2_strcmp_1 tfield2 Not Character = %s\n",tfield2);
								printf("c2z_strcmp.c c2_strcmp_1 rct = %d p_string = %s",rct,p_string);
								c2_debug();
								exit(1);
							}
		...
		if(x == 0)
			{
				printf("c2z_strcmp.c c2_strcmp_1 tfield2 Not Found = %s\n",tfield2);
				printf("c2z_strcmp.c c2_strcmp_1 rct = %d p_string = %s",rct,p_string);
				c2_debug();
				exit(1);
			}
		...
		if(x2 != 1)
			{
						...
						if((ret == 0) && (ret1 == 0))
							{
								...
								if(x1 != 0)
									{
										printf("c2z_strcmp.c c2_strcmp_1 tfield3 Not Character = %s\n",tfield3);
										printf("c2z_strcmp.c c2_strcmp_1 rct = %d p_string = %s",rct,p_string);
										c2_debug();
										exit(1);
									}
				...
				if(x == 0)
					{
						printf("c2z_strcmp.c c2_strcmp_1 tfield3 Not Found = %s\n",tfield3);
						printf("c2z_strcmp.c c2_strcmp_1 rct = %d p_string = %s",rct,p_string);
						c2_debug();
						exit(1);
					}
...
void c2_strcmp_2()				/*  x = strcmp(field1,field2[xx])		*/
	{
		...
		printf("c2z_strcmp.c c2_strcmp_2 NOT CODED\n");
		c2_debug();
		exit(1);		
	}
...
void c2_strcmp_3()				/* xtest = strcmp(array2[pi],gtl_holder	*/
	{
		...
		if((fd1_type == 2) && (fd2_type == 2) && (fd3_type == 2) && (fd4_type == 2))
			{	
				...
				if(x1 == 0)
					{
						printf("c2z_strcmp.c c2_strcmp_3 E-427 field1 Not Found = %s\n",field1);
						c2_error();
					}
				...
				if(x1 == 0)
					{
						printf("c2z_strcmp.c c2_strcmp_3 E-428 field2 Not Found = %s\n",field2);
						c2_error();
					}
				...
				if(x1 == 0)
					{
						printf("c2z_strcmp.c c2_strcmp_3 E-429 field3 Not Found = %s\n",field3);
						c2_error();
					}
				...
				if(x1 == 0)
					{
						printf("c2z_strcmp.c c2_strcmp_3 E-430 field4 Not Found = %s\n",field4);
						c2_error();
					}
				...
				if(x1 == 0)
					{
						printf("c2z_strcmp.c c2_strcmp_3 E-431 field4 Not Found = %s\n",field4);
						c2_error();
					}
				...
				strcpy(a_string, "         ZAP   0(4,R9),0(6,R8)");
				src_line();
				if(punch_code == 1)
					{
		...
		if(x50 == 0)
			{
				printf("c2z_strcmp.c c2_strcmp_3 E-432 Option Not Coded\n");
