...
/* ************************************************************ */
  ...
  /*  c2_str_16				strcpy(f_date, tm[0].tm_mon);			*/
...
*/
  ...
  if (str8 != 0) 			/* not a system variable		*/
  {
    ...
    if (str3 == 0) 
    {
      ...
      if (puncde == 1) 
      {
        strcpy(trace_1, "c2z_strcpy.c #84");
        trace_rec_3();
      }
      ...
      if (puncde == 1) 
      {
        strcpy(trace_1, "c2z_strcpy.c #85");
        trace_rec_3();
      }
      ...
      if (puncde == 1) 
      {
        strcpy(trace_1, "c2z_strcpy.c #86");
        trace_rec_3();
      }
      ...
      if (puncde == 1) 
      {
        strcpy(trace_1, "c2z_strcpy.c #87");
        trace_rec_3();
      }
      ...
      if (puncde == 1) 
      {
        strcpy(trace_1, "c2z_strcpy.c #88");
        trace_rec_3();
      }
      ...
      if (puncde == 1) 
      {
        strcpy(trace_1, "c2z_strcpy.c #89");
        trace_rec_3();
      }
...
printf("c2z_strcpy.c #2 c_name = %d\n",c_name);
}
    c_name++;
    snprintf(wk_strg, sizeof(wk_strg), "%d", c_name);
    strcpy(c_wkname, "C37F");
...
if(rct == 149)
{
printf("c2z_strcpy.c #3 c_wkname = %s\n",c_wkname);
printf("c2z_strcpy.c #4 c_name = %d\n",c_name);
}
...
/* ROW IS GREATER THAN ZERO  */
    ...
    if(fd2_type == 2)
    {
      ...
      if (puncde == 1) 
      {
        strcpy(trace_1, "c2z_print.c #826a");
        trace_rec_3();
      }
      work_use_ct[49]++;
      ...
      if (puncde == 1) 
      {
        strcpy(trace_1, "c2z_strcpy.c #826b");
        trace_rec_3();
      }
      ...
      if (puncde == 1) 
      {
        strcpy(trace_1, "c2z_print.c #826c");
        trace_rec_3();
      }
    }
...
void c2_str_16()
{
  if (traceflg == 1) 
  {
    strcpy(trace_1, "c2z_strcpy.c str_16 START");
    trace_rec_1();
  }
  ...
  if (x3 == 0) 
  {
    printf("\nc2z_strcat.c c2_strcpy_16 strcpy-005 tfield1 Not Found = %s\n", tfield1);
    printf("c2z_string.c c2_strcpy_16 rct = %d p_string = %s", rct, p_string);
    erct++;
    convert = 1;
    return;
  }
  ...
  if (puncde == 1) 
  {
    strcpy(trace_1, "c2z_strcpy.c #1600");
    trace_rec_3();
  }
  work_use_ct[78]++;
    ...
    if (puncde == 1) 
    {
      strcpy(trace_1, "c2z_strcpy.c #1601");
      trace_rec_3();
    }
    work_use_ct[32]++;
    ...
    if (puncde == 1) 
    {
      strcpy(trace_1, "c2z_strcpy.c #1602");
      trace_rec_3();
    }
    ...
    if(fd3_type == 1)
    {
      ...
      if (puncde == 1) 
      {
        strcpy(trace_1, "c2z_strcpy.c #1603");
        trace_rec_3();
      }
      ...
      if (puncde == 1) 
      {
        strcpy(trace_1, "c2z_strcpy.c #1604");
        trace_rec_3();
      }
      work_use_ct[48]++;
      ...
      if (puncde == 1) 
      {
        strcpy(trace_1, "c2z_strcpy.c #1605");
        trace_rec_3();
      }
      ...
      if (puncde == 1) 
      {
        strcpy(trace_1, "c2z_strcpy.c #1606");
        trace_rec_3();
      }
      work_use_ct[78]++;
      ...
      if (puncde == 1) 
      {
        strcpy(trace_1, "c2z_strcpy.c #1607");
        trace_rec_3();
      }
      work_use_ct[48]++;
      ...
      if (puncde == 1) 
      {
        strcpy(trace_1, "c2z_strcpy.c #1608");
        trace_rec_3();
      }
    }
    ...
    if (puncde == 1) 
    {
      strcpy(trace_1, "c2z_strcpy.c #1609");
      trace_rec_3();
    }
    work_use_ct[49]++;
    ...
    if (puncde == 1) 
    {
      strcpy(trace_1, "c2z_strcpy.c #1610");
      trace_rec_3();
    }
    work_use_ct[32]++;
    ...
    if (puncde == 1) 
    {
      strcpy(trace_1, "c2z_strcpy.c #1611");
      trace_rec_3();
    }
    ...
    if (puncde == 1) 
    {
      strcpy(trace_1, "c2z_strcpy.c #1612");
      trace_rec_3();
    }
    ...
    if (puncde == 1) 
    {
      strcpy(trace_1, "c2z_strcpy.c #1613");
      trace_rec_3();
    }
    ...
    if (puncde == 1) 
    {
      strcpy(trace_1, "c2z_strcpy.c #1614");
      trace_rec_3();
    }
    work_use_ct[49]++;
    ...
    if (puncde == 1) 
    {
      strcpy(trace_1, "c2z_strcpy.c #1615");
      trace_rec_3();
    }
    work_use_ct[78]++;
    ...
    if (puncde == 1) 
    {
      strcpy(trace_1, "c2z_strcpy.c #1616");
      trace_rec_3();
    }
    ...
    if (puncde == 1) 
    {
      strcpy(trace_1, "c2z_strcpy.c #1617");
      trace_rec_3();
    }
    ...
    if (puncde == 1) 
    {
      strcpy(trace_1, "c2z_strcpy.c #1618");
      trace_rec_3();
    }
    work_use_ct[49]++;
    ...
    if (puncde == 1) 
    {
      strcpy(trace_1, "c2z_strcpy.c #1619");
      trace_rec_3();
    }
    work_use_ct[33]++;
    ...
    if (puncde == 1) 
    {
      strcpy(trace_1, "c2z_strcpy.c #1620");
      trace_rec_3();
    }
    ...
    if (puncde == 1) 
    {
      strcpy(trace_1, "c2z_strcpy.c #1621");
      trace_rec_3();
    }
    ...
    if (puncde == 1) 
    {
      strcpy(trace_1, "c2z_strcpy.c #1622");
      trace_rec_3();
    }
    ...
    if (puncde == 1) 
    {
      strcpy(trace_1, "c2z_strcpy.c #1623");
      trace_rec_3();
    }
    ...
    if (puncde == 1) 
    {
      strcpy(trace_1, "c2z_strcpy.c #1624");
      trace_rec_3();
    }
    ...
    snprintf(wk_strg, sizeof(wk_strg), "%d", x5a);
    strcpy(a_string, "         MVC   ");
    strcat(a_string, wk_strg);
    strcat(a_string, "(");
    x91--;
    ...
    if (puncde == 1) 
    {
      strcpy(trace_1, "c2z_strcpy.c #1627");
      trace_rec_3();
    }
    ...
    if (puncde == 1) 
    {
      strcpy(trace_1, "c2z_strcpy.c #1628");
      trace_rec_3();
    }
    ...
    if (puncde == 1) 
    {
      strcpy(trace_1, "c2z_strcpy.c #1629");
      trace_rec_3();
    }
    ...
    if (puncde == 1) 
    {
      strcpy(trace_1, "c2z_strcpy.c #1630");
      trace_rec_3();
    }
