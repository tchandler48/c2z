...
void c2_strcpy(void) 
{
  if (traceflg == 1) 
  {
    strcpy(trace_1, "c2z_strcpy.c c2_strcpy START");
    trace_rec_1();
  }
...
/* printf("c2z_strcpy.c #1 rct = %d x90 = %d x91 = %d x91a = %d x92 = %d x93 = %d x93a = %d  x94 = %d x94a = %d x95 = %d x96 = %d x97 = %d\n",rct,x90,x91,x91a,x92,x93,x93a,x94,x94a,x95,x96,x97); */  
  ...
  if ((x90 == 0) && (x91 == 2) && (x92 == 2) && (x93 == 0) && (x94 == 1) && (convert == 0)) 
  {
    c2_str_5();
    convert = 1;
    return;
  ...
  if((x97 == 2) && (convert == 0))		/*  strcpy(xstring, "This is a test\n");  */
  {
...
void c2_str_1(int str1, int str4) 
{
  if (traceflg == 1) 
  {
    strcpy(trace_1, "c2z_strcpy.c c2_str_1 START");
    trace_rec_1();
  }
  ...
  if ((p4) && (!p1) && (!p2)) 
  {
    ...
    if (puncde == 1) 
    {
      strcpy(trace_1, "c2z_strcpy.c c2_str_1 #100");
      trace_rec_3();
    }
    ...
    if (puncde == 1) 
    {
      strcpy(trace_1, "c2z_strcpy.c c2_str_1 #102");
      trace_rec_3();
    }

    strcpy(a_string, "         MVC   ");
    strcat(a_string, "1(");
    snprintf(wk_strg, sizeof(wk_strg), "%d", x10 - 1);
    strcat(a_string, wk_strg);
    strcat(a_string, ",R9),0(R9)");
    src_line();
    if (puncde == 1) 
    {
      strcpy(trace_1, "c2z_strcpy.c c2_str_1 #103");
      trace_rec_3();
    }
    ...
    if (puncde == 1) 
    {
      strcpy(trace_1, "c2z_strcpy.c c2_str_1 #104");
      trace_rec_3();
    }
    ...
    if (puncde == 1) 
    {
      strcpy(trace_1, "c2z_strcpy.c c2_str_1 #105");
      trace_rec_3();
    }
    ...
    if (puncde == 1) 
    {
      strcpy(trace_1, "c2z_strcpy.c c2_str_1 #106");
      trace_rec_3();
    }
    ...
    if (puncde == 1) 
    {
      strcpy(trace_1, "c2z_strcpy.c c2_str_1 #107");
      trace_rec_3();
    }
    work_use_ct[48]++;
    ...
    if (puncde == 1) 
    {
      strcpy(trace_1, "c2z_strcpy.c c2_str_1 #108");
      trace_rec_3();
    }
    ...
    if (puncde == 1) 
    {
      strcpy(trace_1, "c2z_strcpy.c c2_str_1 #110");
      trace_rec_3();
    }
    ...
    if (puncde == 1) 
    {
      strcpy(trace_1, "c2z_strcpy.c c2_str_1 #113");
      trace_rec_3();
    }
    ...
    if (puncde == 1) 
    {
      strcpy(trace_1, "c2z_strcpy.c c2_str_1 #114");
      trace_rec_3();
    }
    work_use_ct[48]++;
    ...
    if (puncde == 1) 
    {
      strcpy(trace_1, "c2z_strcpy.c c2_str_1 #115");
      trace_rec_3();
    }
    ...
    if (puncde == 1) 
    {
      strcpy(trace_1, "c2z_strcpy.c c2_str_1 #116");
      trace_rec_3();
    }
    work_use_ct[48]++;
    ...
    if (puncde == 1) 
    {
      strcpy(trace_1, "c2z_strcpy.c c2_str_1 #117");
      trace_rec_3();
    }
    ...
    if (puncde == 1) 
    {
      strcpy(trace_1, "c2z_strcpy.c c2_str_1 #118");
      trace_rec_3();
    }
    ...
    if (puncde == 1) 
    {
      strcpy(trace_1, "c2z_strcpy.c c2_str_1 #119");
      trace_rec_3();
    }
    ...
    if (puncde == 1) 
    {
      strcpy(trace_1, "c2z_strcpy.c c2_str_1 #120");
      trace_rec_3();
    }
    ...
    if (puncde == 1) 
    {
      strcpy(trace_1, "c2z_strcpy.c c2_str_1 #121");
      trace_rec_3();
    }
    work_use_ct[74]++;
    ...
    if (puncde == 1) 
    {
      strcpy(trace_1, "c2z_strcpy.c c2_str_1 #122");
      trace_rec_3();
    }
...
void c2_str_2(int str1,int str2) 		/* strcpy(p_string, arrary1{line_ndx]")	*/
{
  if (traceflg == 1) 
  {
    strcpy(trace_1, "c2z_strcpy.c c2_str_2 START");
    trace_rec_1();
  }
...
void c2_str_3(int str1, int str2) 
{
  if (traceflg == 1) 
  {
    strcpy(trace_1, "c2z_strcpy.c c2_str_3 START");
    trace_rec_1();
  }
    ...
    if (str1 > str2) 
    {
      ...
      if (str3 == 0) 
      {
        ...
        if(fd2_type == 1)
        {
          ...
          if (puncde == 1) 
          {
            strcpy(trace_1, "c2z_strcpy.c c2_str_3 #5a");
            trace_rec_3();
          }
          ...
          if (puncde == 1) 
          {
            strcpy(trace_1, "c2z_strcpy.c c2_str_3 #5b");
            trace_rec_3();
          }
          ...
          if (puncde == 1) 
          {
            strcpy(trace_1, "c2z_strcpy.c c2_str_3 #5c");
            trace_rec_3();
          }
          ...
          if (puncde == 1) 
          {
            strcpy(trace_1, "c2z_strcpy.c c2_str_3 #5d");
            trace_rec_3();
          }
          ...
          if (puncde == 1) 
          {
            strcpy(trace_1, "c2z_strcpy.c c2_str_3 #5e");
            trace_rec_3();
          }
          ...
          if (puncde == 1) 
          {
            strcpy(trace_1, "c2z_strcpy.c c2_str_3 #5f");
            trace_rec_3();
          }
        }
        ...
        if (puncde == 1) 
        {
          strcpy(trace_1, "c2z_strcpy.c c2_str_3 #6");
          trace_rec_3();
        }
        work_use_ct[49]++;
        ...
        if (puncde == 1) 
        {
          strcpy(trace_1, "c2z_strcpy.c c2_str_3 #7");
          trace_rec_3();
        }
        work_use_ct[32]++;
        ...
        if (puncde == 1) 
        {
          strcpy(trace_1, "c2z_strcpy.c c2_str_3 #8");
          trace_rec_3();
        }
        ...
        if (puncde == 1) 
        {
          strcpy(trace_1, "c2z_strcpy.c c2_str_3 #9");
          trace_rec_3();
        }
        ...
        if (puncde == 1) 
        {
          strcpy(trace_1, "c2z_strcpy.c c2_str_3 #10");
          trace_rec_3();
        }
        ...
        if (puncde == 1) 
        {
          strcpy(trace_1, "c2z_strcpy.c c2_str_3 #11");
          trace_rec_3();
        }
        ...
        if (fd2_type == 1) 
        {
          ...
          if (puncde == 1) 
          {
            strcpy(trace_1, "c2z_math.c c2_math_1 #12a");
            trace_rec_3();
           }
        }
        ...
        if (fd2_type == 2) 
        {
          ...
          if (puncde == 1) 
          {
            strcpy(trace_1, "c2z_strcpy.c c2_str_3 #12b");
            trace_rec_3();
          }
        }
        ...
        if (puncde == 1) 
        {
          strcpy(trace_1, "c2z_strcpy.c c2_str_3 #13");
          trace_rec_3();
        }
        ...
        if (puncde == 1) 
        {
          strcpy(trace_1, "c2z_strcpy.c c2_str_3 #14");
          trace_rec_3();
        }
        ...
        if (puncde == 1) 
        {
          strcpy(trace_1, "c2z_strcpy.c c2_str_3 #15");
          trace_rec_3();
        }
        ...
        if (puncde == 1) 
        {
          strcpy(trace_1, "c2z_strcpy.c c2_str_3 #16");
          trace_rec_3();
        }
        ...
        if (puncde == 1) 
        {
          strcpy(trace_1, "c2z_strcpy.c c2_str_3 #17");
          trace_rec_3();
        }
        ...
        if (puncde == 1) 
        {
          strcpy(trace_1, "c2z_strcpy.c c2_str_3 #18");
          trace_rec_3();
        }
        ...
        if (puncde == 1) 
        {
          strcpy(trace_1, "c2z_strcpy.c c2_str_3 #19");
          trace_rec_3();
        }
        ...
        if (puncde == 1) 
        {
          strcpy(trace_1, "c2z_strcpy.c c2_str_3 #20");
          trace_rec_3();
        }
        ...
        if (puncde == 1) 
        {
          strcpy(trace_1, "c2z_strcpy.c c2_str_3 #22");
          trace_rec_3();
        }
      }
...
/* printf("c2z_strcpy.c str_5 rct = %d x92 = %d x95 = %d x91 = %d x96 = %d\n",rct,x92,x95,x91,x96); */
...
printf("\nc2z_strcpy.c str_9 rct = %d p_string = %s",rct,p_string);
 printf("c2z_strcpy.c str_9 x20 = %d x21 = %d x22 = %d\n",x20,x21,x22);
...
printf("c2z_strcpy.c str_9 field1 = %s\n",field1);
  ...
  field2[pi2] = '\0';
printf("c2z_strcpy.c str_9 field2 = %s fd2_type = %d\n",field2, fd2_type);
...
printf("c2z_strcpy.c str_10 field1 = %s\n",field1);
  ...
  field2[pi2] = '\0';
printf("c2z_strcpy.c str_10 field2 = %s fd2_type = %d\n",field2, fd2_type);
  ...
  field3[pi2] = '\0';
printf("c2z_strcpy.c str_10 field3 = %s\n",field3);
  ...
  field4[pi2] = '\0';
printf("c2z_strcpy.c str_10 field4 = %s\n",field4);
  ...
  field5[pi2] = '\0';
printf("c2z_strcpy.c str_10 field5 = %s fd5_type = %d\n",field5, fd5_type);
