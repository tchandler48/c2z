...
void c2_strrev(void)
	{
		...
		if(x1 == 0)
			{
				printf("c2z_strrev.c c2_strrev tfield1 not Found %s\n",tfield1);
				printf("c2z_strrev.c c2_strrev rct = %d p_string = %s",rct,p_string);
				c2_debug();
				exit(1);
			}
		...
		if(x1 == 0)
			{
				printf("c2z_strrev.c c2_strrev tfield2 Not Found %s\n",tfield2);
				printf("c2z_strrev.c c2_strrev rct = %d p_string = %s",rct,p_string);
				c2_debug();
				exit(1);
			}
