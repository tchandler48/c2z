...
void c2_strset(void)
	{					
				...
				if(ret == 0)
					{
						...
						if(x1 != 0)
							{
								printf("c2z_strset.c c2_strset field1 Not Character = %s\n",field1);
								printf("c2z_strset.cc2_strset rct = %d p_string = %s",rct,p_string);
								c2_debug();
								exit(1);
							}
						if(x1 == 0)
		...
		if(x == 0)
			{
				printf("c2z_strset.c c2_strset field1 Not Found = %s\n",field1);
				printf("c2z_strset.c c2_strset rct = %d p_string = %s",rct,p_string);
				c2_debug();
				exit(1);
			}
