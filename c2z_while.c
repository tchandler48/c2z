...
*/
    ...
    if (x80 == 0) 
    {
      ...
      if(fd3_type == 2)
      {
        ...
        if (puncde == 1) 
        {
          strcpy(trace_1, "c2z_while.c c2_while_4 #3a");
          trace_rec_3();
        }
        ...
        if (puncde == 1) 
        {
          strcpy(trace_1, "c2z_while.c c2_while_4 #3b");
          trace_rec_3();
        }
        ...
        if (puncde == 1) 
        {
          strcpy(trace_1, "c2z_while.c c2_while_4 #3c");
          trace_rec_3();
        }
        ...
        if (puncde == 1) 
        {
          strcpy(trace_1, "c2z_while.c c2_while_4 #3d");
          trace_rec_3();
        }
        ...
        if (puncde == 1) 
        {
          strcpy(trace_1, "c2z_while.c c2_while_4 #3e");
          trace_rec_3();
        }
        ...
        if (puncde == 1) 
        {
          strcpy(trace_1, "c2z_while.c c2_while_4 #3f");
          trace_rec_3();
        }


/*3  3      c2z_math.c c2_math_1 #13                 LAEY  R5,0                            0                    0000099
3  3      c2z_math.c c2_math_1 #14                 LARL  R7,C370U                                                 0000100
3  3      c2z_math.c c2_math_1 #15                 CVD   R5,0(R7)                                                 0000101
3  3      c2z_math.c c2_math_1 #16                 LARL  R8,C370NWK1                                              0000102
3  3      c2z_math.c c2_math_1 #17                 LARL  R7,C370U                                                 0000103
3  3      c2z_math.c c2_math_1 #18                 ZAP   0(6,R8),0(8,R7)                                          0000104
*/
...
*/
    ...
    if (whfd2_type == 2) 
    {
      ...
      if (puncde == 1) 
      {
        strcpy(trace_1, "c2z_while.c c2_while_13 #607");
        trace_rec_3();
      }
    }
    ...
    if (puncde == 1) 
    {
      strcpy(trace_1, "c2z_while.c c2_while_13 #608");
      trace_rec_3();
    }
    ...
    if (puncde == 1) 
    {
      strcpy(trace_1, "c2z_while.c c2_while_13 #609");
      trace_rec_3();
    }
    ...
    if (puncde == 1) 
    {
      strcpy(trace_1, "c2z_while.c c2_while_13 #610");
      trace_rec_3();
    }
    ...
    if (puncde == 1) 
    {
      strcpy(trace_1, "c2z_while.c c2_while_13 #611");
      trace_rec_3();
    }
    ...
    if (puncde == 1) 
    {
      strcpy(trace_1, "c2z_while.c c2_while_13 #612");
      trace_rec_3();
    }
    ...
    if (puncde == 1) 
    {
      strcpy(trace_1, "c2z_while.c c2_while_13 #613");
      trace_rec_3();
    }
    ...
    if (puncde == 1) 
    {
      strcpy(trace_1, "c2z_while.c c2_while_13 #614");
      trace_rec_3();
    }
    ...
    if (puncde == 1) 
    {
      strcpy(trace_1, "c2z_while.c c2_while_13 #615");
      trace_rec_3();
    }
    ...
    if (puncde == 1) 
    {
      strcpy(trace_1, "c2z_while.c c2_while_13 #616");
      trace_rec_3();
    }
    ...
    if (puncde == 1) 
    {
      strcpy(trace_1, "c2z_while.c c2_while_13 #617");
      trace_rec_3();
    }
    ...
    if (puncde == 1) 
    {
      strcpy(trace_1, "c2z_while.c c2_while_13 #618");
      trace_rec_3();
    }
      ...
      if (lv_ct > 0) 
      {
        for (v = 0; v < lv_ct; v++) 
        {
          ...
          if ((ret == 0) && (ret1 == 0)) 
          {
            ...
            strcpy(field3a, lw_variable[v].lv_cname);
            lw_variable[v].lv_use_ct++;
      /*      fd3_lgth = lw_variable[v].lv_current_lgth; */
          }
        }
      }
        ...
        if (gv_ct > 0) 
        {
          for (v = 0; v < gv_ct; v++) 
          {
            ...
            if (wh_4 == 0) 
            {
              ...
              strcpy(field3a, gw_variable[v].gv_cname);
              gw_variable[v].gv_use_ct++;
         /*     fd3_lgth = gw_variable[v].gv_current_lgth; */
            }
          }
        }
      }
